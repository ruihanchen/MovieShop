...
namespace MovieShopMVC.Controllers
{
    ...
    {
        private readonly ICurrentLogedInUser _currentLoggedInUser;
        private readonly IUserService _userService;

        public UserController(ICurrentLogedInUser currentLoggedInUser, IUserService userService)
        {
        ...
        public async Task<IActionResult> BuyMovie(PurchaseRequestModel purchaseRequest, int movieId)
        {
            ...
            if (!purchased)
            {
                ...
                var purchases = await _userService.PurchaseMovie(purchaseRequest, userId);
            }
